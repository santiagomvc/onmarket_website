# flake8: noqa
"""
Django settings for onmarket_website project.
...
DJANGO_ROOT = root.path('onmarket_website')
...
ROOT_URLCONF = 'onmarket_website.urls'

#Admins see https://docs.djangoproject.com/en/dev/ref/settings/#admins
ADMINS = (
    ("""Santiago Velez""", 'santiagomvc@gmail.com'),
)
...
WSGI_APPLICATION = 'onmarket_website.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///onmarket_website'),
}
...
WAGTAIL_SITE_NAME = "OnMarket_Website"
